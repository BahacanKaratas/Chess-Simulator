...
public class Pawn extends Piece{
    ...
    public boolean canMove(String newPosition) {
        ...
        if(this.getColor().equals("white")){
            if(iWeAreOn==6){
                if((iWeWantToGo==4 || iWeWantToGo==5)&& (jWeWantToGo==jWeAreOn)){
                    return true;
                }
                else{
                    if(iWeAreOn-iWeWantToGo==1 && Math.abs(jWeAreOn-jWeWantToGo)==1){
                        return true;
                    }
                    return false;
                }
                ...
                if(iWeAreOn-iWeWantToGo==1){
                    if(iWeAreOn-iWeWantToGo==1 && Math.abs(jWeAreOn-jWeWantToGo)==1){
                        return true;
                    }
                    if(jWeAreOn==jWeWantToGo && iWeAreOn-iWeWantToGo==1){
                        return true;
                    }
                    return false;
                }
            ...
            if(iWeAreOn==1){
                if((iWeWantToGo==2 || iWeWantToGo==3) && (jWeWantToGo==jWeAreOn)){
                    return true;
                }
                else{
                    if(iWeWantToGo-iWeAreOn==1 && Math.abs(jWeAreOn-jWeWantToGo)==1){
                        return true;
                    }
                    return false;
                }
                ...
                if(iWeWantToGo-iWeAreOn==1){
                    if(Math.abs(jWeAreOn-jWeWantToGo)==1 && iWeWantToGo-iWeAreOn==1){
                        return true;
                    }
                    if(jWeAreOn==jWeWantToGo && iWeWantToGo-iWeAreOn==1){
                        return true;
                    }
                    return false;
                }
